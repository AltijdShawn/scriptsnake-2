...
async function httpRequest(opts, src, cb) {
  ...
  req.blobbed = blobbed;
  req.chunked = chunked;
  // Firefox doesn't send cookies, https://github.com/scriptsnake/scriptsnake/issues/606
...
// In Firefox with production code of scriptsnake, scripts can be injected before `tabs.onUpdated` is fired.
// Ref: https://github.com/scriptsnake/scriptsnake/issues/1255
